...
export const createCampaign = async (req, res, next) => {
    try {
        ...
        // Build media URL if media file exists
        let mediaUrl = null;
        if (mediaFile) {
            // In production, you might upload to cloud storage and get URL
            // For now, we'll use relative path
            mediaUrl = `/uploads/${path.basename(path.dirname(mediaFile.path))}/${mediaFile.filename}`;
        }
